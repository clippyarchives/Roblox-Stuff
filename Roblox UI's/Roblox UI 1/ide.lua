...
local btnedit = make(tabs, "TextButton", "edit"); btnedit.Size = UDim2.new(0,60,1,0); btnedit.Position = UDim2.new(0,0,0,0); btnedit.Text = "edit"; btnedit.Font = Enum.Font.Code; btnedit.TextSize = 16; btnedit.TextColor3 = Color3.fromRGB(200,200,205); btnedit.BackgroundTransparency = 1;
local btncfg = make(tabs, "TextButton", "settings"); btncfg.Size = UDim2.new(0,90,1,0); btncfg.Position = UDim2.new(0,70,0,0); btncfg.Text = "settings"; btncfg.Font = Enum.Font.Code; btncfg.TextSize = 16; btncfg.TextColor3 = Color3.fromRGB(140,140,150); btncfg.BackgroundTransparency = 1;
...
local ttl = make(top, "TextLabel", "ttl"); ttl.Size = UDim2.new(1,-(180+46),1,0); ttl.Position = UDim2.new(0,180,0,0); ttl.BackgroundTransparency = 1; ttl.Text = "roblox ide"; ttl.Font = Enum.Font.Code; ttl.TextSize = 16; ttl.TextColor3 = Color3.fromRGB(200,200,205);
...
for i=1,3 do
  ...
  local bar = make(s_sld, "Frame", "bar_"..i); bar.Size = UDim2.new(1,-(pad*2+100),0,6); bar.Position = UDim2.new(0,pad+100,0,y+9); bar.BackgroundColor3 = Color3.fromRGB(18,18,22); bar.BorderSizePixel = 0; local bc = Instance.new("UICorner"); bc.CornerRadius = UDim.new(1,0); bc.Parent = bar; local fill = make(bar, "Frame", "fill"); fill.Size = UDim2.new(0.5,0,1,0); fill.Position = UDim2.new(0,0,0,0); fill.BackgroundColor3 = Color3.fromRGB(120,180,120); fill.BorderSizePixel = 0; local fc = Instance.new("UICorner"); fc.CornerRadius = UDim.new(1,0); fc.Parent = fill; sd[i] = {bar=bar,fill=fill,val=0.5};
